...
const Footer = () => {
  return (
    <div className="w-full bg-darkModerateCyanfooter text-white py-20 flex flex-col justify-center items-center">
      <div className="flex justify-center items-center">
        <svg 
          width="124" 
          height="24" 
          xmlns="http://www.w3.org/2000/svg"
          className="fill-graphicDesigntext"
          >
          <path
...
{/* social icons */}
        <div className="flex justify-center items-center mt-[5rem] space-x-6">
            {icons.map((icon) => (
            <Image
                key={icon.name}
                src={icon.src}
                ...
                height={24}
                alt={icon.alt}
                className="cursor-pointer hover:opacity-80 hover:fill-white transition duration-300 ease-in-out"
            />
            ))}
        </div>
